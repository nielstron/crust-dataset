...
pub fn test_value_serialize() {
    ...
    assert_eq!(
        rm_serializer::serialize_value(&rm_serializer::string_to_value("i10")),
        "i10"
    );
    assert_eq!(
        rm_serializer::serialize_value(&rm_serializer::string_to_value("f5.3")),
        "f5.3"
    );
    assert_eq!(
        rm_serializer::serialize_value(&rm_serializer::string_to_value("sHello world")),
        "sHello world"
    );
    assert_eq!(
        rm_serializer::serialize_value(&rm_serializer::string_to_value("bt")),
        "bt"
    );
    assert_eq!(
        rm_serializer::serialize_value(&rm_serializer::string_to_value("btrue")),
        "btrue"
    );
}
...
pub fn testOperators() {
    ...
    assert_eq!(
        expr::value_equals(
            &rm_serializer::string_to_value("i10"),
            &rm_serializer::string_to_value("i10"),
            &mut result
        ),
        dberror::RC::Ok
    ...
    assert_ne!(
        expr::value_equals(
            &rm_serializer::string_to_value("i9"),
            &rm_serializer::string_to_value("i10"),
            &mut result
        ),
        dberror::RC::Ok
    ...
    assert_eq!(
        expr::value_equals(
            &rm_serializer::string_to_value("sHello World"),
            &rm_serializer::string_to_value("sHello World"),
            &mut result
        ),
        dberror::RC::Ok
    ...
    assert_ne!(
        expr::value_equals(
            &rm_serializer::string_to_value("sHello Worl"),
            &rm_serializer::string_to_value("sHello World"),
            &mut result
        ),
        dberror::RC::Ok
    ...
    assert_ne!(
        expr::value_equals(
            &rm_serializer::string_to_value("sHello Worl"),
            &rm_serializer::string_to_value("sHello Wor"),
            &mut result
        ),
        dberror::RC::Ok
    );
    ...
    assert_eq!(
        expr::value_smaller(
            &rm_serializer::string_to_value("i3"),
            &rm_serializer::string_to_value("i10"),
            &mut result
        ),
        dberror::RC::Ok
    ...
    assert_ne!(
        expr::value_smaller(
            &rm_serializer::string_to_value("f5.0"),
            &rm_serializer::string_to_value("f6.5"),
            &mut result
        ),
        dberror::RC::Ok
    );
    ...
    assert_eq!(
        expr::bool_and(
            &rm_serializer::string_to_value("bt"),
            &rm_serializer::string_to_value("bt"),
            &mut result
        ),
        dberror::RC::Ok
    ...
    assert_ne!(
        expr::bool_and(
            &rm_serializer::string_to_value("bf"),
            &rm_serializer::string_to_value("bt"),
            &mut result
        ),
        dberror::RC::Ok
    ...
    assert_eq!(
        expr::bool_not(&rm_serializer::string_to_value("bt"), &mut result),
        dberror::RC::Ok
    );
}
...
fn test_expressions() {
    ...
    assert!(
        expr::value_equals(&rm_serializer::string_to_value("i10"), &res, &mut res2)
            == dberror::RC::Ok,
        "Const 10"
    );
    ...
    assert!(
        expr::value_equals(&rm_serializer::string_to_value("i20"), &res, &mut res2)
            == dberror::RC::Ok,
        "Const 20"
    );
    ...
    assert!(
        expr::value_equals(&rm_serializer::string_to_value("bt"), &res, &mut res2)
            == dberror::RC::Ok,
        "Const 10 < Const 20"
    );
