use dict::dict::{
    dict_deserialize, dict_destroy, dict_get, dict_key, dict_new, Dict, DictAlloc, DictArgs,
    DictKeyAttr, DictType, DictValAttr,
};
use std::fs::File;
...
fn test5() {
    ...
    buf_reader
        .read_to_end(&mut data2)
        .expect("Failed to read test5.bin");
