use dict::dict::{
    dict_create_args, dict_destroy, dict_get, dict_key, dict_remove, Dict, DictAlloc, DictArgs,
    DictCmpr, DictDeepCopy, DictDestructor, DictHash, DictKeyAttr, DictType, DictValAttr,
};
use std::mem::size_of;
